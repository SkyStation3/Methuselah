...
#ifndef METHUSELAH_VERSION_H
#define METHUSELAH_VERSION_H
...
static const int MIN_POOL_PEER_PROTO_VERSION = 99999;

//! minimum peer version for masternode budgets
static const int MIN_BUDGET_PEER_PROTO_VERSION = 99999;
