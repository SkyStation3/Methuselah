    ...
    mapper(0)
{
    ...
    ui->methuselahAtStartup->setText(ui->methuselahAtStartup->text().arg(tr(PACKAGE_NAME)));
    ...
    ui->thirdPartyTxUrls->setPlaceholderText("https://explorer.methuselahcoin.io/#/tx/%s");
#endif

    ui->unit->setModel(new MethuselahUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->methuselahAtStartup, OptionsModel::StartAtStartup);
